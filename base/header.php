    <header class="blog-header py-3">
      ...
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          ...
          <p class="fecha">
    <?php 
    function fecha_nice($fecha_ori) {
      $week_days = array ("domingo", "lunes", "martes", "miércoles", "jueves", "viernes", "sábado");
      $months = array ("", "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre");
      list($yy,$mm,$dd)=explode("-",$fecha_ori);
      $nice = intval($dd) . " " . $months[intval($mm)] . " " . $yy;
      return $nice;
    }
    function fecha_hora($fecha_ori) {
      $week_days = array ("domingo", "lunes", "martes", "miércoles", "jueves", "viernes", "sábado");
      $months = array ("", "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre");
      list($yy,$mm,$dd)=explode("-",$fecha_ori);
      list($aux,$hora)=explode(" ",$fecha_ori);
      $nice = intval($dd) . " " . $months[intval($mm)] . " " . $yy.", ".$hora;
      return $nice;
    }    
