<?php 
  ...
  if( !isset($_GET['id']) ) {
    ...
    $id = $_GET['id'];
    $consulta = $con->query("SELECT * FROM secciones WHERE id=$id");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Eliminar sección</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form id="nuevaNoticia" name="nuevaNoticia" enctype="multipart/form-data" method="post" action="consultas/del_sec.php">
                ¿Está seguro de querer eliminar la sección <strong><?=$origin['nombre']?></strong>? <br>
                Las noticias y los comentarios asociados a esta sección también se eliminarán.      
                <hr>       
