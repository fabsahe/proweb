<?php 
  ...
  if( !isset($_GET['id']) ) {
    ...
    $id = $_GET['id'];
    $consulta = $con->query("SELECT * FROM usuarios WHERE id=$id");
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form id="nuevoUsr" name="nuevoUsr" enctype="multipart/form-data" method="post" action="consultas/edit_usr.php">
                <div class="form-group">
                  <input type="hidden" name="id" value="<?=$id?>">
                  <label for="alias">Nombre de usuario</label>
                  <input type="text" class="form-control form-control-user" id="alias" name="alias" value="<?=$origin['alias']?>" required>
                </div>
                <div class="form-group">
                  <label for="nombre">Nombre real</label>
                  <input type="text" class="form-control form-control-user" id="nombre" name="nombre" value="<?=$origin['nombre']?>" required>
                </div>
                <div class="form-group">
