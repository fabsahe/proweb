<?php 
  ...
  if( isset($_COOKIE['id'] ) && isset( $_COOKIE['marca'] ) ) {
    if($_COOKIE['id']!="" || $_COOKIE['marca']!=""){
      $sql_c = $con->query("SELECT * FROM usuarios 
            WHERE id='".$_COOKIE["id"]."' 
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bienvenido a Panela</h1>
                  </div>
                  <form class="user" action="basepan/auth.php" method="post">
                    <?php 
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck" name="recordar">
