    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Editar sección</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form id="nuevoUsr" name="nuevoUsr" enctype="multipart/form-data" method="post" action="consultas/edit_sec.php">
                <div class="form-group">
                  <input type="hidden" name="id" value="<?=$id?>">
                  <label for="alias">Nombre de la sección</label>
                  <input type="text" class="form-control form-control-user" id="seccion" name="seccion" value="<?=$origin['nombre']?>" required>
                </div>
