        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form id="nuevaNoticia" name="nuevaNoticia" enctype="multipart/form-data" method="post" action="consultas/del_usr.php">
                <input type="hidden" name="autor" value="<?=$origin['alias']?>">
                ¿Está seguro de querer eliminar al usuario <strong><?=$origin['nombre']?></strong>? <br>
                Las noticias creadas por este usuario también se eliminarán.      
                <hr>       
