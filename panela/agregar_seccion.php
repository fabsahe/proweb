    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Agregar sección</h1>


          <!-- Formulario -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Nueva sección</h6>
            </div>
            <div class="card-body">
              <div class="col-lg-6">

              <form id="nuevoUsr" name="nuevoUsr" enctype="multipart/form-data" method="post" action="consultas/ins_sec.php">
                <div class="form-group">
                  <label for="alias">Nombre de la sección</label>
                  <input type="text" class="form-control form-control-user" id="seccion" name="seccion" required>
                </div>
