      ...
      <div class="row">
        <div class="col-md-9 blog-main">
          ...
          <div class="blog-post">
            ...
            <?php 
            $consulta1 = $con->query("SELECT * FROM noticias WHERE id_seccion=$_seccion ORDER BY likes DESC");
            $cont=0;
            $it = 0;
            foreach ($consulta1 as $row1) {
              ...
              echo "<div class=\"col-md-4\">
                      <div class=\"noti-preview\">
                        <a class=\"link-noti\" href=\"ver_noticia.php?id_sec=".$_seccion."&id_noti=".$row1['id']."\">
                          <img src=\"img/".$row1['foto']."\" width=\"250\" height=\"150\">
                        </a>
                          <div>".substr($row1['titulo'],0,54);
              if( strlen($row1['titulo'])>54 )
                echo " ...";   
              echo "</div>      
                      </div>
                    </div>\n";
